...
# Se não existirem, tentar a antiga
if 'MATA-MATA 16' not in excel.sheet_names:
    mata_mata_sheets = {'MATA-MATA 32': 'MATA-MATA 32'}
...
for sheet_name, df in [('ORGANIZAÇÃO', org)]:
...
# Processar cada fase de mata-mata
for display_name, sheet_name in mata_mata_sheets.items():
